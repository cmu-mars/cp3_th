...
class Parameters(object):
    ...
    def id(self):
        ...
        the element of LIGHTSET whose state will be set  # noqa: E501
    ...
    @property
    def state(self):
        """Gets the state of this Parameters.  # noqa: E501

        upon response, the named light will be on if `true` and `off` otherwise  # noqa: E501

        :return: The state of this Parameters.  # noqa: E501
        :rtype: bool
        """
        return self._state
    ...
    def state(self, state):
        ...
        :param state: The state of this Parameters.  # noqa: E501
        :type: bool
        """
        if state is None:
