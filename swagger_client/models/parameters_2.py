...
class Parameters2(object):
    ...
    @property
    def id(self):
        """Gets the id of this Parameters2.  # noqa: E501

        cause the named node to fail  # noqa: E501

        :return: The id of this Parameters2.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this Parameters2.  # noqa: E501
        :type: str
        """
        if id is None:
            raise ValueError("Invalid value for `id`, must not be `None`")  # noqa: E501
        allowed_values = ["amcl", "mrpt", "aruco"]  # noqa: E501
